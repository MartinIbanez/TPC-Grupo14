...
namespace negocio
{
    public class TurnoNegocio
    {
        ...
        public void Agregar(Turno nuevo)
        {
            ...
            try
            {
                //datos.SetearConsulta("INSERT INTO Turnos(IdProfesional, IdPaciente, FechaTurno, HoraTurno, IdEspecialidad, Estado, Observaciones) VALUES(" + nuevo.ProfesionalTurno.Id + "," + nuevo.PacienteTurno.Id + ",'" + nuevo.FechaTurno.Date + "'," + nuevo.HoraTurno + "," + nuevo.EspecialidadTurno.Id + "," + nuevo.EstadoTurno + ",'" + nuevo.Observaciones + "')");
